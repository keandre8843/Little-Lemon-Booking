  ...
  return (
    <footer className="site-footer" role="contentinfo">
      <div className="footer-content">
        ...
        <nav className="footer-section" aria-labelledby="social-heading">
          ...
          <ul className="social-links">
            <li>
              <a 
                ...
                aria-label="Visit Little Lemon on Facebook (opens in new tab)"
              >
            ...
            <li>
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                aria-label="Visit Little Lemon on Instagram (opens in new tab)"
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <li>
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                aria-label="Visit Little Lemon on Twitter (opens in new tab)"
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
